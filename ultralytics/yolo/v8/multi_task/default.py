...
_C.MODEL.HEADS_NAME = ['']
_C.MODEL.PRETRAINED = ''#"/data/rakesh/FASD_seg/YOLOP/weights/End-to-end.pth" #TODO
...
# _C.DATASET.DATAROOT = '/data/rakesh/FASD_seg/YOLOP/dataset/bdd100k/images/100k'       # the path of images folder
# _C.DATASET.LABELROOT = '/data/rakesh/FASD_seg/YOLOP/dataset/bdd100k/labels/100k'      # the path of det_annotations folder
# _C.DATASET.MASKROOT = '/data/rakesh/FASD_seg/YOLOP/dataset/bdd100k/bdd_seg_gt'                # the path of da_seg_annotations folder
# _C.DATASET.LANEROOT = '/data/rakesh/FASD_seg/YOLOP/dataset/bdd100k/bdd_lane_gt'               # the path of ll_seg_annotations folder

_C.DATASET.DATAROOT = '/data/rakesh/YOLOv8/ultralytics/ultralytics/yolo/v8/multi_task/coco-pose/images'       # the path of images folder
_C.DATASET.LABELROOT = '/data/rakesh/YOLOv8/ultralytics/ultralytics/yolo/v8/multi_task/coco-pose/labels'      # the path of label folder folder
_C.DATASET.MASKROOT = '/data/rakesh/YOLOv8/ultralytics/ultralytics/yolo/v8/multi_task/coco-pose/masks'        # the path of da_seg_annotations folder

_C.DATASET.DATASET = 'YOLODataset'
...
_C.TRAIN.LR0 = 0.0001  # initial learning rate (SGD=1E-2, Adam=1E-3)
...
_C.TEST.MODEL_FILE = '/data/rakesh/FASD_seg/YOLOP/runs/BddDataset/_2023-05-23-21-08/epoch-115.pth'
